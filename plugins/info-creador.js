...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `💨 ム 𝐉𝐎𝐒𝐓𝐈𝐍-444 ㋰`, dev, 'coderzmasterteam.1@gmail.com', `🇬🇹 Guatemala`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🍜`, `${packname}`, `📵 No Hacer Spam`, 'https://youtube.com/@gastinff?si=NTRpRtW6zuI5XF2R', `https://github.com/Giovanni-OFC/BorutoBot-MD`, biobot]
], m)
