...
text: `🚩¡Lograste cometer tu crimen con exito!, acabas de robar *${amountTaken} Rasengan 🌀* a @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} Rasengan 🌀* a ${senderName}.`,
contextInfo: { 
...
conn.reply(m.chat, `🚩 No fuiste cuidadoso y te atraparon mientras cometias tu cirme, se restaron *-${amountSubtracted} Rasengan 🌀* a ${senderName}.`, m, rcanal)
break
case 2:
...
conn.sendMessage(m.chat, {
text: `🚩 Lograste cometer tu crimen con exito, pero te descubrieron y solo lograste tomar *${smallAmountTaken} Rasengan 🌀* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} Rasengan 🌀* a ${senderName}.`,
contextInfo: { 
mentionedJid: [randomUserId],
}}, { quoted: m })
break
