...
global.authFile = 'BorutoSession'
global.authFileJB  = 'BorutoJadiBot'
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['BorutoBot-MD', 'Edge', '20.0.04'] : methodCodeQR ? ['BorutoBot-MD', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
if (opts['autocleartmp'] && (global.support || {}).find) (tmp = [os.tmpdir(), 'tmp', "BorutoJadiBot"], tmp.forEach(filename => cp.spawn('find', [filename, '-amin', '2', '-type', 'f', '-delete'])))}, 30 * 1000)}
...
const directories = ['./BorutoSession/', './BorutoJadiBot/']
